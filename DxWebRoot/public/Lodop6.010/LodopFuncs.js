function getLodop(oOBJECT, oEMBED) {
	 ...
	 **************************/
	var strHtml1 = "<br><font color='#FF00FF'>打印控件未安装!点击这里<a href='"
			+ DX_PUBLIC
			+ "/public/Lodop6.010/install_lodop.exe'>执行安装</a>,安装后请刷新页面或重新进入。</font>";
	var strHtml2 = "<br><font color='#FF00FF'>打印控件需要升级!点击这里<a href='"
			+ DX_PUBLIC
			+ "/public/Lodop6.010/install_lodop.exe'>执行升级</a>,升级后请重新进入。</font>";
	...
	try {
		...
		$.dialog({title:'提示',content:err,esc:true,lock:true});
		//	document.documentElement.innerHTML=""+strHtml1+document.documentElement.innerHTML;
		return false;
	}
}
