...
class DxExtAccountModel extends DxExtCommonModel{
    public  $listFields = array (
            "account_id"    => array('type'=>'int','size'=>10, 'pk'=>true),
            "username"      => array( 'type'=>'varchar','size'=>45 ,'title'=>'系统登录账号名'),
            "pwd"           => array( 'type'=>'varchar','size'=>200,'title'=>'登录密码'),
            ...
            "role_id"       => array('type'=>' int','size'=>10,'title'=>'角色id'),
            ...
            "create_time"   => array( 'type'=>'timestamp','title'=>'创建时间'),
            "status"        => array('type'=>'tinyint','size'=>1,'title'=>"状态",'COMMENT'=> '1.正常 0:未验证 -1:已删除 2:禁用'),
    );
